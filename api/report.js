export default async function handler(req, res) {
  ...
  const body = { model: 'claude-sonnet-4-20250514', max_tokens: 2000, system: 'Sos un analista financiero senior especializado en eToro y mercados globales. Respondés siempre en español con JSON estructurado cuando se te pide.', messages: [{ role: 'user', content: prompt }], ...(tools && { tools }) };
  try {
